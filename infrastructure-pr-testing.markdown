...
aurora task ssh -l root <ID> "echo &#123&#123mesos.instance&#125&#125 > config/worker-index"
```
...
aurora task ssh -l root <ID>/0-3 "echo &#123&#123mesos.instance&#125&#125 > config/worker-index"
```
...
aurora task ssh -l root <ID>/4-7 "echo $((&#123&#123mesos.instance&#125&#125 - 4)) > config/worker-index"
```
...
aurora task ssh -l root <ID>/0-7 "echo &#123&#123mesos.instance&#125&#125 > config/worker-index"
